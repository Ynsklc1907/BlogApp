...
namespace BlogApp.Controllers
{
    public class PostsController : Controller
    {
        ...
        // {
        //     return View(await _postRepository.Posts.FirstOrDefaultAsync(x => x.PostId == id));
        // }

        public async Task<IActionResult> Details(string url)
        {
            return View(await _postRepository.Posts
            .Include(x => x.User)//Postun User bilgisini çekerken
            .Include(x => x.Tags)
            .Include(x => x.Comments)
            .ThenInclude(x => x.User)//Her commentin user bilgisini çekmek için kullanıyoruz.
